...
class Test(unittest.TestCase):
    ...
    def test_example(self):
        ...
        while True:
            ...
            # compter ici le nombre de page # //ul[@class='oxd-pagination__ul']/li
        ...
        self.assertEqual(total_count, 90)  #ATTENTION ici valeur en dure (90) !! l'ideal serais de compter les employée avant >
                                            # puis rajouter un employé > puis recompter > verification 
                                            # assertEqual (comptage avant+1 , comptage aprés)
