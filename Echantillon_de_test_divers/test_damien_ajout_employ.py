...
class Test(unittest.TestCase):
    ...
    def test_(self):
        ...
        ## compter le nonbre de page 
        #nbpage = driver.find_elements(By.CLASS_NAME, "oxd-pagination__ul") # ne fonctionne pas
        nbpage = driver.find_elements(By.XPATH, "//ul[@class='oxd-pagination__ul'][1]/li")
        print("Nombre de page : ", len(nbpage))
        ...
        #     # Accumuler le total
        #     total_count_before += count_on_page

        #     print(f'Page actuelle: {count_on_page} éléments sur la premiere page | Total jusqu à présent: {total_count_before} éléments')
            
        #     if count_on_page < 50 :
        #         break
        #     else :
        #         next_page_button1 = self.driver.find_element(By.XPATH, "//button[@class='oxd-pagination-page-item oxd-pagination-page-item--previous-next']")

        #         if 'disabled' in next_page_button1.get_attribute('class'):
        ...
        driver.find_element(By.NAME,"middleName").send_keys("jo")
